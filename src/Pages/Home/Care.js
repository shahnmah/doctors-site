...
const Care = () => {
    return (
        <div class="card lg:card-side bg-base-100 shadow-xl grid grid-cols-1 lg:grid-cols-2 gap-5 mt-36">
            <figure><img className='rounded-lg' style={{ height: '576px', width: '458px' }} height={'576px'} src={treatmentImg} /></figure>
            <div class="card-body justify-center">
                <div>
                    <h2 class="card-title text-5xl mb-6 text-accent">Exceptional Dental Care, on Your Terms</h2>
