...
const Appointment = () => {
    return (
        <div className="card lg:card-side bg-base-100 shadow-xl grid grid-cols-1 lg:grid-cols-2 gap-5 mt-52 rounded-none" style={{ backgroundImage: `url(${appointmentImg})`, height: '533px', overflow:'inherit' }}>
